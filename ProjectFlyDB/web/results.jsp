    ...
    <body>
        ...
        <div id="container">
            ...
            <%
                ...
                int isNotEmpty = 0;
                int LeftOrRight = 0;
                if (request.getParameter("service").equals("fly")) {
                    typeofservice = 1;
                }
                switch (typeofservice) {
                    case 1:
                        ...
                        int comma = from_air.lastIndexOf(',');
                        from_air = from_air.substring(comma + 2);
                    }
                    ; {
                        int comma = to_air.lastIndexOf(',');
                        to_air = to_air.substring(comma + 2);
                    }
                    ;
            ...
            <form name="flightform" method="get" action="checkout.jsp">
                ...
                <span class="<% if ((LeftOrRight % 2) == 0) {
                    ...
                    <%
                        ...
                        if (rsfly.getInt("seats") == 0) {
                            out.println("There are no seats left on this flight.");
                            if (!rsfly.next()) {
                            break;
                            }
                            continue;
